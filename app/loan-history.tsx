...
export default function LoanHistory() {
	...
	useJourneyTracker("/loan-history");
		...
		<View style={[styles.container, { paddingTop: insets.top, paddingBottom: insets.bottom }]}>
			...
			<View style={styles.content}>
				<View style={styles.iconCircle}>
					<MaterialIcons name="history" size={40} color={primary} />
				</View>
				<Text style={styles.title}>Loan History</Text>
				<Text style={styles.subtitle}>
					Track all your past closed loans, payment receipts, and settlement letters here. This feature is coming soon.
				</Text>
			</View>
		</View>
	);
